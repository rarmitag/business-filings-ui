...
// Mixins
import { FilingMixin, ResourceLookupMixin } from '@/mixins'

// Enums
import { EntityTypes, FilingCodes, FilingStatus, FilingTypes } from '@/enums'

export default {
  name: 'CorrectionOfficeAddress',
  ...
  mixins: [FilingMixin, ResourceLookupMixin],
  ...
  computed: {
    ...
    validated () {
      ...
      return (staffPaymentValid && this.detailCommentValid && this.certifyFormValid && this.officeAddressFormValid && filingDataValid)
    },
  ...
  created (): void {
    ...
    // Set true if this is a correction
    this.isCorrection = +this.$route.params.isCorrection
